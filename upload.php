...
$username = "admin";
$password = "78817881ard;20100M123";
...
$bucketName = 'sylvain-ard-933b085d'; // Remplacez par le nom de votre bucket S3
$region = 'us-east-1'; // Remplacez par votre région AWS
require 'vendor/autoload.php';

$cloudFrontDomain = 'd3noyz48y5kek0.cloudfront.net'; // Remplacez par votre domaine CloudFront
...
$s3Client = new S3Client([
    ...
    'version' => 'latest',
    'credentials' => [
        'key' => '[remplacer par l\'id de clé AWS]',
        'secret' => '[remplacer par la clé secrète AWS]',
    ],
]);
